...
static char aStatic[] = "Static";
static char aButton[] = "Button";
static char aEditbox[] = "Editbox";
static char aCheckbox[] = "Checkbox";
static char aRadiobutton[] = "Radiobutton";
static char aListbox[] = "Listbox";
static char aEnabled[] = "Enabled";
static char aVisible[] = "Visible";
static char aImage[] = "Image";
static char aHotkey[] = "Hotkey";
static char aSpace[] = "Space";
static char aEnter[] = "Enter";
static char aEsc[] = "Esc";
static char aColor[] = "Color";
static char aNormal[] = "Normal";
static char aPush[] = "Push";
static char aLit[] = "Lit";
static char aPos[] = "Pos";
static char aSize[] = "Size";
static char aZ[] = "Z";
static char aBoundpos[] = "BoundPos";
static char aBoundsize[] = "BoundSize";
static char aTextcentered[] = "TextCentered";
static char aTextpos[] = "TextPos";
static char aTextsize[] = "TextSize";
static char aTextz[] = "TextZ";
static char aEditmaxchars[] = "EditMaxChars";
static char aEditrestricted[] = "EditRestricted";
static char aTextfont[] = "TextFont";
static char aText[] = "Text";
static char aTextcolor[] = "TextColor";
static char aSlave1[] = "Slave1";
static char aSlave2[] = "Slave2";
...
char __cdecl sub_423600(_DWORD *self)
{
  ...
  v98 = 0;
  String1 = 0;
  if ( sub_40AAF0((int)(void *)v96, aControl, 0) )
  {
    while ( 1 )
    {
      sub_40AA40((int)(void *)v96, aControl);
      v2 = (char *)operator new(0xC0u);
      memset(v2, 0, 0xC0u);
      v2[45] = 1;
      v2[44] = 1;
      sub_40AFC0(v96, aName, (_DWORD *)&String1);
      v4 = strlen(String1) + 1;
      v3 = &String1[v4];
      qmemcpy(v2, String1, 4 * (v4 >> 2));
      qmemcpy(&v2[4 * (v4 >> 2)], &v3[4 * (v4 >> 2) - v4], v4 & 3);
      sub_40AFC0(v96, aType, (_DWORD *)&String1);
...
LABEL_115:
    ...
    *((_DWORD *)v2 + 9) = 6;
LABEL_14:
    if ( sub_40ABC0((int)(void *)v96, aEnabled, 0) )
      sub_40B130((const char *)v96, aEnabled, (_BYTE *)v2 + 45);
    if ( sub_40ABC0((int)(void *)v96, aVisible, 0) )
      sub_40B130((const char *)v96, aVisible, (_BYTE *)v2 + 44);
    v5 = *((_DWORD *)v2 + 9);
    if ( (v5 == 1 || v5 == 3) && sub_40ABC0((int)(void *)v96, aImage, 0) )
    {
      sub_40AFC0(v96, aImage, (_DWORD *)&String1);
      *((_DWORD *)v2 + 37) = (int)sub_4242F0((_DWORD **)v96, String1);
    }
    if ( sub_40ABC0((int)(void *)v96, aHotkey, 0) )
    {
      sub_40AFC0(v96, aHotkey, (_DWORD *)&String1);
      v6 = 0;
      if ( *String1 )
      {
    ...
    v75 = 255;
    v2[46] = 0;
    if ( sub_40ABC0((int)(void *)v96, aColor, 0) )
    {
      sub_40AFC0(v96, aColor, (_DWORD *)&String1);
    ...
    {
      if ( sub_40ABC0((int)(void *)v96, aNormal, 0) )
      {
        sub_40AFC0(v96, aNormal, (_DWORD *)&String1);
        *((_DWORD *)v2 + 37) = (int)sub_4242F0((_DWORD **)v96, String1);
      }
      if ( sub_40ABC0((int)(void *)v96, aPush, 0) )
      {
        sub_40AFC0(v96, aPush, (_DWORD *)&String1);
        *((_DWORD *)v2 + 38) = (int)sub_4242F0((_DWORD **)v96, String1);
      }
      if ( sub_40ABC0((int)(void *)v96, aLit, 0) )
      {
        sub_40AFC0(v96, aLit, (_DWORD *)&String1);
        *((_DWORD *)v2 + 39) = (int)sub_4242F0((_DWORD **)v96, String1);
      }
    }
    *((_DWORD *)v2 + 13) = 0;
    *((_DWORD *)v2 + 12) = 0;
    if ( sub_40ABC0((int)(void *)v96, aPos, 0) )
    {
    ...
    *((_DWORD *)v2 + 15) = 0;
    *((_DWORD *)v2 + 14) = 0;
    if ( sub_40ABC0((int)(void *)v96, aSize, 0) )
    {
...
LABEL_53:
    *((_DWORD *)v2 + 16) = 0;
    if ( sub_40ABC0((int)(void *)v96, aZ, 0) )
      sub_40AF60((const char *)v96, aZ, (float *)v2 + 16);
    v16 = *((_DWORD *)v2 + 13);
    *((_DWORD *)v2 + 17) = *((_DWORD *)v2 + 12);
    *((_DWORD *)v2 + 18) = v16;
    if ( sub_40ABC0((int)(void *)v96, aBoundpos, 0) )
    {
    ...
    *((_DWORD *)v2 + 20) = v18;
    if ( sub_40ABC0((int)(void *)v96, aBoundsize, 0) )
    {
    ...
    if ( sub_40ABC0((int)(void *)v96, aTextcentered, 0) )
      sub_40B130((const char *)v96, aTextcentered, (_BYTE *)v2 + 104);
    v20 = *((_DWORD *)v2 + 13);
    *((_DWORD *)v2 + 21) = *((_DWORD *)v2 + 12);
    *((_DWORD *)v2 + 22) = v20;
    if ( sub_40ABC0((int)(void *)v96, aTextpos, 0) )
    {
    ...
    *((_DWORD *)v2 + 24) = v22;
    if ( sub_40ABC0((int)(void *)v96, aTextsize, 0) )
    {
    ...
    *((_DWORD *)v2 + 25) = 0;
    if ( sub_40ABC0((int)(void *)v96, aTextz, 0) )
      sub_40AF60((const char *)v96, aTextz, (float *)v2 + 25);
    if ( *((_DWORD *)v2 + 9) == 3 )
    {
      if ( sub_40ABC0((int)(void *)v96, aEditmaxchars, 0) )
        sub_40AF00((const char *)v96, aEditmaxchars, (char **)v2 + 35);
      if ( sub_40ABC0((int)(void *)v96, aEditrestricted, 0) )
        sub_40B130((const char *)v96, aEditrestricted, (_BYTE *)v2 + 144);
    }
    v24 = (_DWORD *)(v2 + 108);
    if ( *((_DWORD *)v2 + 9) == 6 )
    {
      *v24 = 4;
      if ( sub_40ABC0((int)(void *)v96, aTextfont, 0) )
        sub_40AF00((const char *)v96, aTextfont, (char **)v2 + 27);
      v25 = sub_421B20((_DWORD *)v96, *((_DWORD *)v2 + 27));
      v26 = v25 - 2;
      if ( v25 == 2 )
      {
        v27 = 1;
      ...
      *(float *)&v69 = (float)v29;
      do
      {
        v32 = (int)sub_409AD0((int *)(void *)v96, *((_DWORD *)v2 + 27), 64);
        v33 = v69;
        v34 = (double)v67;
    ...
    else
    {
      *v24 = 3;
      if ( sub_40ABC0((int)(void *)v96, aTextfont, 0) )
        sub_40AF00((const char *)v96, aTextfont, (char **)v2 + 27);
      if ( sub_40ABC0((int)(void *)v96, aText, 0) )
      {
        v38 = *((_DWORD *)v2 + 9);
        v76 = 255;
        v71 = 186;
        ...
        if ( v38 == 2 )
          v70 = 191;
        if ( sub_40ABC0((int)(void *)v96, aTextcolor, 0) )
        {
          sub_40AFC0(v96, aTextcolor, (_DWORD *)&String1);
          sscanf(String1, "%d,%d,%d,%d", &v76, &v71, &v77, &v70);
        }
        sub_40AFC0(v96, aText, (_DWORD *)&String1);
        v39 = (int)sub_409AD0((int *)(void *)v96, *v24, 64);
        v64 = v70;
        v62 = v77;
        v60 = v71;
        v59 = v76;
        *((_DWORD *)v2 + 28) = v39;
        ...
        {
          *(_BYTE *)(v40 + 35) = 1;
          sub_421370((_DWORD *)*((_DWORD *)v2 + 28), 0, 0, 0, 255);
        }
        sub_421110((LPVOID *)*((_DWORD *)v2 + 28), String1);
        if ( v2[104] )
        {
          v42 = *((_DWORD *)v2 + 28);
...
LABEL_95:
    if ( sub_40ABC0((int)(void *)v96, aSlave1, 0) )
    {
      sub_40AFC0(v96, aSlave1, (_DWORD *)&String1);
      v44 = v68;
      v45 = (int)sub_424350((_DWORD *)v96, String1);
      *((_DWORD *)v2 + 46) = v45;
      if ( v45 )
        *(_BYTE *)(v45 + 45) = 0;
    }
    ...
    if ( sub_40ABC0((int)(void *)v96, aSlave2, 0) )
    {
      sub_40AFC0(v96, aSlave2, (_DWORD *)&String1);
      v46 = (int)sub_424350((_DWORD *)v96, String1);
      *((_DWORD *)v2 + 47) = v46;
      if ( v46 )
        *(_BYTE *)(v46 + 45) = 0;
    }
    ...
    *(_BYTE *)(&v98) = 1;
    ...
    v61 = v73;
    *(_BYTE *)(&v98) = 0;
    *((_DWORD *)v2 + 44) = (int)v50;
    sub_413160((int)(void *)v96, v61, v63, v65);
    sub_413180(*((_DWORD *)v2 + 44), v75, 1);
    sub_428680(v68, *((_DWORD *)v2 + 44));
LABEL_110:
    v51 = v44[8];
    v52 = v44[7] + 1;
    v44[7] = v52;
    ...
    *(_DWORD *)(v44[6] + 4 * v44[7] - 4) = (int)v2;
    goto LABEL_115;
  }
LABEL_116:
  v98 = -1;
  sub_40A830((int)(void *)v96);
  return 1;
}
