...
char **__thiscall sub_451390(char **this, char *FileName)
{
  ...
  *this = (char *)&off_499ADC;
  ...
  v4 = (char *)(this + 1);
  sub_40AF00(v25, aNumstrips, this + 1);
  v5 = (int)this[1];
  ...
  if ( !v8 )
  {
    ...
    do
    {
      sub_40AFE0(aStrip_0, (char **)&this[2][v9]);
      ++v7;
      v9 += 12;
    }
    while ( v7 < *(_DWORD *)v4 );
  }
  sub_40AF00(v25, aNumtextures, this + 3);
  this[4] = (char *)operator new(264 * (_DWORD)this[3]);
  v10 = 0;
  if ( (int)this[3] > 0 )
  {
    v22 = 0;
    do
    {
      ...
      v22 += 264;
      ++v10;
      *(_DWORD *)&this[4][v22 - 4] = 0;
    }
    while ( v10 < (int)this[3] );
  }
  v14 = 0;
  for ( i = 0; i < (int)this[1]; ++i )
  {
    sub_40AA40((int)v25, *(char **)&this[2][v14]);
    sub_40AF00(v25, aNumframes, (char **)&this[2][v14 + 4]);
    v15 = 0;
    *(_DWORD *)&this[2][v14 + 8] = operator new(36 * *(_DWORD *)&this[2][v14 + 4]);
    if ( *(int *)&this[2][v14 + 4] > 0 )
    {
      v16 = 0;
      do
      {
        sprintf(Buffer, "t%d", v15);
        sub_40AF00(v25, Buffer, (char **)(v16 + *(_DWORD *)&this[2][v14 + 8]));
        sprintf(Buffer, "s%d", v15);
        v17 = *(_DWORD *)&this[2][v14 + 8] + v16;
        sub_40B1F0(v25, Buffer, (float *)(v17 + 4), (float *)(v17 + 8));
        sprintf(Buffer, "o%d", v15);
        v18 = v16 + *(_DWORD *)&this[2][v14 + 8];
        sub_40B1F0(v25, Buffer, (float *)(v18 + 12), (float *)(v18 + 16));
        sprintf(Buffer, "u%d", v15);
        v19 = *(_DWORD *)&this[2][v14 + 8] + v16;
        sub_40B1D0(v25, Buffer, (float *)(v19 + 20), (float *)(v19 + 28));
        sprintf(Buffer, "v%d", v15);
        v20 = *(_DWORD *)&this[2][v14 + 8] + v16;
        sub_40B1D0(v25, Buffer, (float *)(v20 + 24), (float *)(v20 + 32));
        ++v15;
        v16 += 36;
      }
      while ( v15 < *(_DWORD *)&this[2][v14 + 4] );
    }
    v14 += 12;
  }
