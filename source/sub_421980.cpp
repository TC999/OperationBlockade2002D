...
_BYTE *__cdecl sub_421980(int self, int a2, unsigned int a3)
{
  ...
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 18) = 255;
    *((_DWORD *)v5 + 19) = 255;
    v6 = (_BYTE *)operator new(a3);
    *((_DWORD *)v5 + 2) = (uint32)(uintptr_t)v6;
    *v6 = 0;
    sub_421300((int)v5, 0xFFu, 0xFFu, 0xFFu, 255);
    sub_421370((_DWORD *)v5, 0, 0, 0, 255);
    sub_421540((void **)v5);
  }
  else
  {
  ...
  *(_DWORD *)(self + 40) = v8;
  if ( v8 > v7 )
  {
    v9 = v7 + 8;
    *(_DWORD *)(self + 44) = v9;
    v10 = (int)(uintptr_t)sub_488DD7(*(LPVOID *)(self + 36), 4 * v9);
    if ( v10 )
    {
      v11 = *(_DWORD *)(self + 40);
  ...
  *(_DWORD *)(*(_DWORD *)(self + 36) + 4 * *(_DWORD *)(self + 40) - 4) = (uint32)(uintptr_t)v5;
  return v5;
}
