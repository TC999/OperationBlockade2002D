...
int __thiscall sub_466AA0(int this)
{
  ...
  *(_DWORD *)(*(_DWORD *)(this + 416) + 32) = 0;
  sub_408640(*(_DWORD *)(*(_DWORD *)(this + 412) + 1116), 1);
  sub_408640(*(_DWORD *)(*(_DWORD *)(this + 412) + 1128), 1);
  sub_408640(*(_DWORD *)(*(_DWORD *)(this + 412) + 1140), 1);
  sub_407670(*(_DWORD *)(*(_DWORD *)(this + 412) + 1128), 1);
  sub_407670(*(_DWORD *)(*(_DWORD *)(this + 412) + 1140), 1);
