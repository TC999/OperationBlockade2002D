  ...
  while ( 1 )
  {
    ...
    *((float *)v8 + 2) = v61 + *((float *)v8 + 2);
    if ( *(float *)(v3 + 4) != 0.0 )
    {
      ...
      sub_46B97C(v3 - 84, v66, v3 - 84);
    }
    v22 = *(_DWORD *)(v3 + 32);
    memset(v65, 0, sizeof(v65));
    sub_44E6F0(v22, v3 - 84, v65);
    if ( *(_DWORD *)(v3 + 36) )
    {
    ...
    if ( *(float *)(v3 - 12) < 1000.0 || *((float *)v8 + 2) < 1000.0 )
    {
      if ( *(_BYTE *)(v3 - 88) )
      {
        if ( v25 )
          goto LABEL_40;
        v25 = sub_456000(v3 - 20, v8, v3 - 96, &v46);
        if ( v25 )
          goto LABEL_40;
        v25 = sub_465CF0(v3 - 20, v8, v3 - 96, COERCE_FLOAT(&v46));
        if ( v25 )
          goto LABEL_40;
      ...
      else
      {
        if ( v25 )
          goto LABEL_40;
        v26 = sub_461D40(COERCE_FLOAT(v3 - 20), *(float *)&v8, v3 - 96, (int)&v46);
      }
      v25 = v26;
    }
LABEL_40:
    if ( (*(float *)(v3 - 12) < 3000.0 || *((float *)v8 + 2) < 3000.0) && !v25 )
    {
      ...
      v59[1] = v27;
      v59[2] = v28;
      if ( !(unsigned __int8)sub_468CA0((int)v59, (int)v8, COERCE_FLOAT(&v51), (int)&v49)
...
LABEL_64:
        if ( *(float *)(v3 + 20) > 0.0 )
        {
          ...
          v29 = sub_44DF20(*(float *)(v30 + 340), *(float *)&v8, (int)v64);
        }
      }
      v31 = *(_DWORD *)(v3 - 92);
      v32 = *(float *)(v31 + 308);
