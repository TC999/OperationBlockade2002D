//----- (00471771) --------------------------------------------------------
static void __cdecl _nullsub_2_stub(int) {}
extern "C" int __cdecl _setjmp3(void*, int);
int __cdecl sub_471771(_DWORD *self, int a2, int a3)
{
  ...
  v31 = self;
  v23 = (int)(void*)sub_4789FA(v20);
  v20[0] = sub_4716F6;
  v21 = (int(*)())_nullsub_2_stub;
  if ( _setjmp3(v22, 0) )
    goto LABEL_2;
  sub_476C11((_DWORD*)(void*)&v23, 61, 424);
  v4 = (_DWORD *)(*(int (__cdecl **)(int *, _DWORD, int))v24)(&v23, 0, 36);
  v25 = v4;
  v4[8] = a3;
  v4[2] = (uint32)(void*)_nullsub_2_stub;
  v4[3] = (uint32)(void*)sub_471746;
  v4[4] = (uint32)(void*)sub_47175E;
  v4[5] = (uint32)(void*)sub_478747;
  v4[6] = (uint32)(void*)_nullsub_2_stub;
  v4[1] = 0;
  *v4 = 0;
  v4[7] = a2;
  sub_476F95((_DWORD*)(void*)&v23, 1);
  v21 = (int(*)())sub_471714;
  sub_477129((int)(void*)&v23);
  if ( v28 == 1 )
  {
    v6 = v31;
    v5 = v26;
        ...
        (v30 = v11) != 0) )
  {
    if ( *v6 == 50 )
    {
      ...
      if ( v29 < v27 )
      {
        while ( 1 )
        {
          sub_4770A5((_DWORD*)(void*)&v23, (int)(void*)v11, 1);
          qmemcpy(v12, *v11, v26);
          v12 += v26;
          if ( v29 >= v27 )
            break;
