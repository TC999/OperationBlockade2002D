...
char __thiscall sub_43E100(int self, char *String1, int a3)
{
  ...
  if ( !_strcmpi(String1, aTimeOfDay) )
  {
    if ( *(_BYTE *)(dword_4F5CC4 + 936) )
    {
      ...
      *(_DWORD *)(self + 104) = v5;
      ...
      sub_422DC0((HKEY)AppName, aMultiplayersky, *(_DWORD *)(self + 104));
  ...
  if ( _strcmpi(String1, aMonth) )
  {
    if ( !_strcmpi(String1, aDifficulty_0) )
    {
      ...
      *(_DWORD *)(*(_DWORD *)(dword_520970 + 236) + 20) = *(_DWORD *)(self + 108);
      sub_43E0C0((_DWORD *)self);
      return 1;
    }
LABEL_38:
    ...
    {
      if ( String1 == *(char **)(self + 64) )
      {
        v19 = *(_DWORD *)(*(_DWORD *)(self + 52) + 124);
        if ( v19 > 0 )
        {
      ...
      else if ( String1 == *(char **)(self + 60) && *(_BYTE *)(dword_4F5CC4 + 936) )
      {
    ...
    if ( byte_521684 )
      ...
      sub_4261C0(*(_DWORD **)(self + 40), aTcpip_0, 0);
    return 1;
  }
  if ( !*(_BYTE *)(dword_4F5CC4 + 936) )
    return 1;
