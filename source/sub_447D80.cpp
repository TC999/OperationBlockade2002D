...
char __thiscall sub_447D80(int this)
{
  ...
  if ( v6 != 3 )
  {
    if ( v6 == 4 )
    {
      v31 = *(_DWORD *)(*(_DWORD *)(this + 444) + 4132);
      v17 = (float *)sub_417140(0);
      if ( sub_419C40(*(_DWORD *)(this + 444), v17) )
      {
        v18 = (float *)sub_417120(*(_DWORD *)(*(_DWORD *)(this + 444) + 4132) - 1);
        v19 = (float *)sub_417120(*(_DWORD *)(*(_DWORD *)(this + 444) + 4132) - 2);
        v27 = -1.0;
        if ( v18[1] * *v19 - v19[1] * *v18 <= 0.0 )
          v27 = 1.0;
        while ( sub_419910(*(_DWORD *)(this + 444), v27, 0.0, COERCE_FLOAT(1), 1, 0) )
        {
          v20 = (float *)sub_417120(*(_DWORD *)(*(_DWORD *)(this + 444) + 4132) - 1);
          v21 = (float *)sub_417120(*(_DWORD *)(*(_DWORD *)(this + 444) + 4132) - 2);
...
LABEL_39:
      ...
      sub_4164A0(*(_DWORD **)(this + 444), v31);
      return 0;
    }
    if ( v6 != 6 && v6 != 7 )
      return 0;
LABEL_41:
    ...
    return sub_416350(*(_DWORD *)(this + 444), v23, 0);
  }
  v10 = *(_DWORD *)(*(_DWORD *)(this + 444) + 4132);
  v11 = (float *)sub_417140(0);
  if ( !sub_419C40(*(_DWORD *)(this + 444), v11) )
    goto LABEL_24;
  v12 = *(_DWORD *)(this + 408);
  v25 = *(float *)(v12 + 804);
  v28 = *(float *)(v12 + 808);
  ...
  v14 = 1;
  v30 = *(_DWORD *)(v13 + 4284);
  *(_DWORD *)(v13 + 4284) = *(_DWORD *)(*(_DWORD *)(this + 408) + 812);
  v29 = 0.0;
  if ( v26 > 0.0 )
  {
    while ( sub_419910(*(_DWORD *)(this + 444), 0.0, 0.0, COERCE_FLOAT(1), 1, 1) )
    {
      v15 = v29 + *(float *)(*(_DWORD *)(this + 408) + 712);
      v29 = v15;
      if ( v15 >= v26 )
        goto LABEL_22;
    }
...
LABEL_22:
  *(_DWORD *)(*(_DWORD *)(this + 444) + 4284) = v30;
  if ( v14 && sub_419910(*(_DWORD *)(this + 444), 0.0, 0.0, COERCE_FLOAT(1), 1, 1) )
  {
    v16 = v26 + *(float *)(this + 496);
    *(_DWORD *)(this + 436) = 0;
    result = 1;
    *(float *)(this + 496) = v16;
    *(float *)(this + 500) = v26 + *(float *)(this + 500);
  }
  else
  {
LABEL_24:
    sub_4164A0(*(_DWORD **)(this + 444), v10);
    return 0;
  }
  return result;
}
