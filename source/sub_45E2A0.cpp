extern char aStartedLoading_0[];
extern char aChatter[];
extern char aPlayerIni[];
extern char Default[];
extern char aPlayerradius[];
extern char aHeight[];
extern char aMpradius[];
extern char aFpturretmodelf[];
extern char aTurret[];
extern char aCouldnTFindTur[];
extern char aMpturretmodelf[];
extern char aCouldnTFindTur_0[];
extern char aBarrel[];
extern char aCouldnTFindBar[];
extern char aMaxdamageangle[];
extern char aMindamageangle[];
extern char aMindamageperce[];
extern char aAdjustgunposit[];
extern char aGrenade[];
extern char aGun_0[];
extern char aFinishedLoadin_1[];
...
char __cdecl sub_45E2A0(int a1, int a2, int a3, int a4, int a5, int a6)
{
  ...
  *(_DWORD *)(a1 + 2596) = (DWORD)sub_403620((_DWORD *)dword_4B5AB0, aChatter);
  *(_DWORD *)(a1 + 508) = 0;
  ...
  sub_40AFC0((void *)a1, aFpturretmodelf, (_DWORD *)&String1);
  v7 = sub_4069C0(*(_DWORD **)(dword_520970 + 128), String1);
  *(_DWORD *)(a1 + 436) = (DWORD)(uintptr_t)v7;
  v8 = sub_405A30((_DWORD*)v7, aTurret, -1, 1);
  *(_DWORD *)(a1 + 440) = v8;
  if ( v8 == -1 )
    sub_4281B0(aCouldnTFindTur);
  sub_40AFC0((void *)a1, aMpturretmodelf, (_DWORD *)&String1);
  v9 = sub_4069C0(*(_DWORD **)(dword_520970 + 128), String1);
  *(_DWORD *)(a1 + 444) = (DWORD)(uintptr_t)v9;
  v10 = sub_405A30((_DWORD*)v9, aTurret, -1, 1);
  *(_DWORD *)(a1 + 448) = v10;
  if ( v10 == -1 )
  ...
  *(_DWORD *)(a1 + 452) = v11;
  ...
  {
    v12 = (int)(uintptr_t)sub_409AD0(NULL, 1, 1024);
    dword_5216FC = v12;
  ...
  *(_DWORD *)(a1 + 2636) = sub_469650((_DWORD *)dword_520970, aGrenade, aGun_0, 1);
  *(_DWORD *)(a1 + 2640) = 0;
  *(_BYTE *)(a1 + 2644) = 0;
  *(_BYTE *)(a1 + 2645) = 0;
  *(_BYTE *)(a1 + 2646) = 0;
  ...
  do
  {
    v15 = (_DWORD *)operator new(0x34u);
    v26 = (v26 & 0xFFFFFF00) | 1;
    if ( v15 )
      v16 = (int *)sub_406B00(v15, *(_DWORD *)(a1 + 436), 1);
    else
      v16 = 0;
    *(v13 - 1) = (int)(uintptr_t)v16;
    v17 = *v16;
    v26 = (v26 & 0xFFFFFF00);
    (*(void (__cdecl **)(int *, _DWORD, int))(v17 + 24))(v16, 0, a2);
    sub_428680((_DWORD *)a1, *(v13 - 1));
    v18 = (_DWORD *)operator new(0x34u);
    v26 = (v26 & 0xFFFFFF00) | 2;
    if ( v18 )
      v19 = sub_406B00(v18, *(_DWORD *)(a1 + 444), 1);
    else
      v19 = 0;
    *v13 = (int)(uintptr_t)v19;
    a2 = 0;
    v26 = (v26 & 0xFFFFFF00);
    (*(void (__cdecl **)(_DWORD *, _DWORD, int))(*v19 + 24))(v19, 0, 0);
