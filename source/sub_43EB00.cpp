...
extern char aYouVeBeenKicke[];
extern char aGameDataIsOutO[];
  ...
  if ( (unsigned __int16)v3 > 0xFF01u )
  {
    if ( v3 == 65283 )
    {
      ...
      else
      {
        ...
        v17 = &((char*)&byte_520D40)[4 * (v20 >> 2)];
        v19 = v20;
      }
      qmemcpy(v17, v18, v19 & 3);
      strcpy((char*)&byte_520D80, aHostLeftTheGam);
      v15 = AppName;
LABEL_34:
      strcpy((char*)&byte_521180, v15);
      v3 = sub_4261C0(*(_DWORD **)(self + 40), (char*)aErrormsg, 0);
    }
  }
  else if ( (unsigned __int16)v3 == 65281 )
  {
    v3 = *(_BYTE *)(dword_4F5CC4 + 936);
    if ( (_BYTE)v3 )
    {
      v3 = *(_DWORD *)(v4 + 6);
      if ( v3 )
        v3 = sub_43E0C0((_DWORD *)self);
    }
  }
  else
  {
    ...
    {
      case 0:
        v3 = sub_45E6F0((_DWORD *)self, *(_DWORD *)(a2 + 4));
        if ( v3 > -1 )
          v3 = sub_43EA00(
                         (_DWORD *)self,
                         (const char *)(v4 + 6),
      ...
      case 1:
        ...
        if ( !(_BYTE)v3 )
        {
          ...
          *(_DWORD *)(self + 108) = *(_DWORD *)(v4 + 14);
          ...
          v7 = (const char *)sub_45A870((_DWORD *)self, *(_DWORD *)(self + 100));
          ...
          if ( v3 )
          {
            if ( v3 == 1 )
            {
              sub_421110(*(LPVOID **)(*(_DWORD *)(self + 88) + 112), aSoldier);
            }
            else if ( v3 == 2 )
            {
              sub_421110(*(LPVOID **)(*(_DWORD *)(self + 88) + 112), aVeteran);
            }
          }
          else
          {
            sub_421110(*(LPVOID **)(*(_DWORD *)(self + 88) + 112), aRecruit);
          }
        }
        break;
      case 2:
        ...
        if ( (_BYTE)v3 )
        {
          v5 = sub_45E6F0((_DWORD *)self, *(_DWORD *)(a2 + 4));
          if ( v5 > -1 )
            *(_BYTE *)(*(_DWORD *)(dword_520970 + 280) + 352 * v5 + 896) = *(_BYTE *)(v4 + 6);
          v3 = sub_463180((_BYTE *)*(_DWORD *)(dword_520970 + 280));
        }
        break;
      case 3:
        sub_411C50(dword_4F5CC4);
        ...
        else
        {
          ...
          v11 = &((char*)&byte_520D40)[4 * (v14 >> 2)];
          v13 = v14;
        }
        qmemcpy(v11, v12, v13 & 3);
        strcpy((char*)&byte_520D80, aYouVeBeenKicke);
        v15 = (const char *)(v4 + 6);
        goto LABEL_34;
      case 4:
        v3 = *(_BYTE *)(dword_4F5CC4 + 936);
        if ( (_BYTE)v3 )
        {
          sub_411EE0(dword_4F5CC4, (char)self, (_DWORD *)(uintptr_t)ArgList, (_DWORD*)(&v22), (uint32*)&v24);
          v3 = *(_DWORD *)(v4 + 10);
          if ( v3 != v24 || *(_DWORD *)(v4 + 14) != v22 || *(_DWORD *)(v4 + 6) != *(_DWORD *)ArgList )
          {
            ...
            v3 = sub_411480((_DWORD *)dword_4F5CC4, (_DWORD *)0x404, *(_DWORD *)(a2 + 4), v25, 262, 7, 0);
          }
        }
        break;
      default:
