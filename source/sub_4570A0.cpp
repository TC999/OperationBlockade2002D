  ...
  *(_DWORD *)(self + 480) = 0;
  ...
  if ( *(float *)(self + 1340) > 0.0 )
  {
    ...
    if ( v9 )
    {
      if ( v9 == 1 )
      {
        ...
        {
          sub_45F160((float *)(self + 408), (float *)(self + 408));
          v80 = *(_DWORD *)(self + 392);
          *(_DWORD *)(self + 456) = 9;
          v81 = v80 + 516;
          v82 = *(_DWORD *)(v81 + 4);
  ...
  if ( *(float *)(self + 1340) > 0.0 && v158 )
  {
    if ( v159 <= (double)*(float *)(self + 1336) )
    {
      ...
      {
        v155 = v160 * 1.5707964;
        sub_41C090((_DWORD *)(self + 492), LODWORD(v155), 1070141403);
      }
      else
      {
        v156 = v160 * -1.5707964;
        sub_41C090((_DWORD *)(self + 492), -1077342245, LODWORD(v156));
      }
    }
    ...
    *(float *)(self + 436) = sub_468BE0((int *)*(_DWORD *)(self + 428), *(_DWORD *)(self + 432), (int)&v173, NULL);
  }
  ...
  if ( *(float *)(self + 1340) <= 0.0 )
  {
    if ( *(_BYTE *)(self + 420) )
    {
      ...
      *(float *)(self + 436) = v197 + *(float *)(self + 436);
      ...
      v187 = *(float *)(self + 428);
      v188 = v148;
      v149 = sub_468BE0((int *)*(_DWORD *)(self + 428), *(_DWORD *)(self + 432), (int)&v174, NULL);
      v189 = v149;
