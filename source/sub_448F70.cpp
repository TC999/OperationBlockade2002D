//----- (00448F70) --------------------------------------------------------
int __fastcall sub_448F70(int a1, int a2, char *String1, char a4)
{
  char *v4; // edi
  int *v6; // ebp
  int v7; // edx
  ...
  *(_DWORD *)(a1 + 336) = 0;
  ...
  {
    sub_40AFC0(aTraileffect, (int)&String1);
    sub_469160(a1 + 336, String1, aEffect);
  }
  *(_DWORD *)(a1 + 340) = 0;
  if ( sub_40ABC0(v4, aExplodeeffect, 0) )
  {
    sub_40AFC0(aExplodeeffect, (int)&String1);
    sub_469160(a1 + 340, String1, aEffect);
  }
  ...
  *(_DWORD *)(a1 + 344) = v9;
  v9[3] = aImpacts;
  sub_469700(*(_DWORD *)(a1 + 344), aCustomImpacts);
  sub_469160(a1 + 344, 0, 0);
  *(_DWORD *)(a1 + 348) = 0;
  if ( sub_40ABC0(v4, aRibbontexture, 0) )
  {
    sub_40AFC0(aRibbontexture, (int)ArgList);
