...
int __cdecl sub_486659(__int16 *a1, __int16 *a2, int *a3, int a4, int a5, int a6)
{
  ...
  do
  {
    ...
    v72 = v43;
    v56 = 25172 * v55 + v41;
    *(_BYTE*)&(v42) = *(_BYTE *)(a6 + (((v42 + v66 + 0x20000) >> 18) & 0x3FF));
    *(_BYTE*)&(v43) = *(_BYTE *)(a6 + (((v62 - v44 + 0x20000) >> 18) & 0x3FF));
    v42 <<= 8;
    v43 <<= 8;
    *(_BYTE*)&(v42) = *(_BYTE *)(a6 + (((v72 + v68 + 0x20000) >> 18) & 0x3FF));
    *(_BYTE*)&(v43) = *(_BYTE *)(a6 + (((v64 - v56 + 0x20000) >> 18) & 0x3FF));
    v42 <<= 8;
    v43 <<= 8;
    *(_BYTE*)&(v42) = *(_BYTE *)(a6 + (((v56 + v64 + 0x20000) >> 18) & 0x3FF));
    *(_BYTE*)&(v43) = *(_BYTE *)(a6 + (((v68 - v72 + 0x20000) >> 18) & 0x3FF));
    v42 <<= 8;
    v43 <<= 8;
    *(_BYTE*)&(v42) = *(_BYTE *)(a6 + (((v44 + v62 + 0x20000) >> 18) & 0x3FF));
    *(_BYTE*)&(v43) = *(_BYTE *)(a6 + (((v66 - v71 + 0x20000) >> 18) & 0x3FF));
    *v27 = v42;
    v27[1] = v43;
    v49 += 8;
    result = --v51;
