...
// AUTO-FIX: Forward declarations for all game functions
...
_DWORD *__cdecl sub_41BB80(_DWORD *self);
...
int __stdcall sub_4013C0(int a1, int a2, int a3, int (__cdecl *a4);
...
int __stdcall sub_46C866(int a1, int a2, int a3, int (__cdecl *a4);
...
int __cdecl sub_405DF0(void (__cdecl ***self);
...
void __cdecl __noreturn sub_48CB2B(EXCEPTION_POINTERS *self);
