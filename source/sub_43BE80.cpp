extern char aHostlist[];
extern char aUiIpxSearchFor[];
extern char aUiIpxUnableToS[];
extern char aNameentry[];
extern char aUnableToSearch[];
...
int __cdecl sub_43BE80(int self)
{
  ...
  *(_DWORD *)(self + 44) = (_DWORD)v2;
  *((_DWORD *)v2 + 33) = 0;
  *(_DWORD *)(self + 112) = 0;
  sub_4229D0(aUiIpxSearchFor);
  sub_40F7B0(dword_4F5CC4, (_DWORD*)(&v4));
  v6 = 0;
  if ( v4 )
  {
