  ...
  switch ( *(_WORD *)(a2 + 12) )
  {
    ...
    case 0x503:
      *(_DWORD *)(self + 100) = 5;
      break;
    case 0x504:
      LOBYTE(v3) = sub_45B2B0(self, (const char *)(v2 + 6));
      break;
    case 0x505:
      *(_BYTE *)(self + 80) = 1;
      v7 = (LPVOID *)sub_450BF0((_DWORD *)dword_520970, 1, 0.0);
      sub_421110(v7, aMissionComplet_0);
      LOBYTE(v3) = sub_41CD90(*(_DWORD *)(self + 232));
      break;
    case 0x506:
      LOBYTE(v3) = sub_45B200((_DWORD *)self);
      break;
    case 0x507:
    ...
    case 0x508:
      ...
      *(_DWORD *)(self + 104) = v8;
      ...
      v3 = *(_DWORD *)(v10 + 12);
      if ( v3 > -1 )
        LOBYTE(v3) = sub_4030B0(*(_DWORD **)(self + 92), *(_DWORD *)(v10 + 16), aCommanderspeci, *(_DWORD *)(v10 + 12));
      break;
    default:
      return v3;
  }
