...
char __cdecl sub_45E760(int self)
{
  ...
  sub_45E960((_DWORD *)self, 1);
  sprintf(Buffer, "Saved\\%s.sps", (const char *)(self + 472));
  v2 = fopen(Buffer, (const char *)(uintptr_t)Mode);
  v3 = v2;
  if ( v2 )
  {
    ...
    if ( *(_DWORD *)ArgList == 305397761 )
    {
      ...
      *(_DWORD *)(self + 508) =(DWORD)(uintptr_t)v5;
    ...
    {
      sub_4229D0((char *)"Bad saved game version 0x%04x, need 0x%04x", *(_DWORD *)ArgList, 305397761);
      return 0;
    }
  }
  else
  {
    sub_4229D0((char *)"Unable to open saved game file %s", Buffer);
    return 0;
  }
}
