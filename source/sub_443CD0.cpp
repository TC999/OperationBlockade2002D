...
bool __thiscall sub_443CD0(int this, int a2, int a3, float a4, float a5)
{
      ...
      if ( v11 > 0.0 )
      {
        *v12 = *v12 - a4;
        if ( *(float *)(*(_DWORD *)(this + 1432) + 860 * i + 12) <= 0.0 )
        {
          ...
          sub_408640(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(this + 408) + 924) + 4 * i) + 28), 0);
          v15 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(this + 408) + 924) + 4 * i) + 32);
          if ( v15 != -1 )
            sub_408640(v15, 0);
          sub_407670(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(this + 408) + 924) + 4 * i) + 52), 0);
        }
      }
      break;
    }
  ...
  if ( (unsigned __int8)sub_4438C0(this) )
  {
    ...
    else if ( *(float *)(v17 + 676) != 0.0 || (unsigned __int8)sub_4438C0(this) )
    {
      if ( *(_BYTE *)(this + 392) )
      {
        v24 = *(float *)(*(_DWORD *)(this + 408) + 668);
        v18 = v24 == 0.0 ? 0.0 : sub_4438E0(this) / v24;
