...
char __thiscall sub_4359A0(int self, int a2)
{
  ...
  *(_BYTE *)(v24 + 33) = 0;
  ...
  do
  {
    ...
    sub_45F3A0(LODWORD(v144[1]), &v131, &v132, &v146);
    v44 = v42[11];
    LODWORD(v147) = v41 + 50;
...
LABEL_101:
    ...
    else
    {
      ...
      if ( v42[14] == 4 )
      {
        ...
        *((float *)v42 + 12) = v62;
        v128 = v62 * 0.017453292;
        v118 = (float)(int)v150;
        v112 = (float)SLODWORD(v136[1]);
        sub_413100(LODWORD(v112), LODWORD(v118), LODWORD(v128));
              ...
              if ( v135 >= 180.0 || v136[0] < 180.0 )
              {
                if ( v135 >= 240.0 || v136[0] < 240.0 )
                {
                  if ( v135 < 300.0 && v136[0] >= 300.0 )
                  {
                    ...
                    sub_413240(1065353216, 1077936128, 255, 0);
                  }
                }
                else
                {
