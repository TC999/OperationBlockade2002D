//----- (0042A5F0) --------------------------------------------------------
char *__thiscall sub_42A5F0(char *this, int a2)
{
  char *v2; // edi
  double v4; // st7
  double v5; // st7
  ...
  *(_DWORD *)this = &off_499400;
  ...
  sub_469160(this + 292, a2, aBullet);
  sub_40B1B0((char)aRof, (int)(this + 296));
  v4 = *((float *)this + 74);
  if ( v4 == 0.0 )
    v5 = 0.0;
  else
  ...
  *((float *)this + 75) = v7;
  ...
  sub_40AF60(v2, aVelocity, (float *)this + 76);
  *((_DWORD *)this + 77) = 0;
  if ( sub_40ABC0(v2, aFireeffect, 0) )
  {
    sub_40AFC0(aFireeffect, (int)v11);
    sub_469160(this + 308, v11[0], aEffect);
  }
  return this;
}
