extern char aSoundStreamsta_0[];
extern char aSoundStreamsta[];

//----- (0041D1A0) --------------------------------------------------------
char __cdecl sub_41D1A0(char *self)
{
  char result; // al
  int v3; // eax
  int v4; // eax
  ...
  if ( ppDS )
  {
    ...
    *((_DWORD *)self + 84) = -1;
    ...
    {
      v6 = (_DWORD *)(self + 304);
      v7 = ((int (__cdecl *)(int, int))sf_open_read)((int)(self + 40), (int)(self + 304));
      *((_DWORD *)self + 75) = v7;
      if ( v7 )
      {
        HIDWORD(v25) = 0;
        ...
        *((float *)self + 1) = v11;
        ...
        v26[2] = (_DWORD)(__int64)((double)(unsigned int)v25 * 2.0);
        v26[4] = v12;
        if ( ppDS->CreateSoundBuffer( (LPCDSBUFFERDESC)v26, (LPDIRECTSOUNDBUFFER *)(self + 32), 0) >= 0 )
        {
          ...
          *((_DWORD *)self + 83) = v26[2] >> 1;
          (*(void (__stdcall **)(unsigned int, _DWORD, int, __int64 *, int *, _DWORD, _DWORD, _DWORD))(*(_DWORD *)v13 + 44))(
            ...
            0,
            0);
          v15 = 2 * ((int (__cdecl *)(_DWORD, int, unsigned int))sf_read_short)(*((_DWORD *)self + 75), v25, (unsigned int)v24 >> 1);
          if ( v15 < v24 )
          {
            ((void (__cdecl *)(int))sf_close)(*((_DWORD *)self + 75));
              *((_DWORD *)self + 75) = 0;
              ++dword_5200DC;
              if ( *self )
              {
                v16 = ((int (__cdecl *)(int, int))sf_open_read)((int)(self + 40), (int)(self + 304));
              *((_DWORD *)self + 75) = v16;
              *((_DWORD *)self + 7) = 0;
              if ( v16 )
              {
                ++dword_5200D8;
                ((int (__cdecl *)(_DWORD, int, unsigned int))sf_read_short)(*((_DWORD *)self + 75), v25 + v15, (unsigned int)(v24 - v15) >> 1);
              }
              else
              {
                sub_4229D0(aCanTResetStrea, self + 40);
              }
            }
            else
            {
              ...
              *((_DWORD *)self + 84) = v15;
              v19 = *(_WORD *)(v18 + 14) == 8;
              v18 = (v18 & 0xFFFF) | (v25 & 0xFFFF0000);
              v20 = v17 - v15;
              v21 = (char *)(v25 + v15);
              v18 = (v18 & 0xFFFFFF00) | (!v19 ? 0 : 0x80);
              v18 = (v18 & 0xFFFF00FF) | ((v18 & 0xFF) << 8);
              v22 = v18 << 16;
              v22 = (v22 & 0xFFFF0000) | (v18 & 0xFFFF);
