      ...
      *((_DWORD *)this + 75) = v7;
      if ( v7 )
      {
        ...
        *((float *)this + 1) = v11;
        ...
        v26[4] = v12;
        if ( ppDS->lpVtbl->CreateSoundBuffer(ppDS, (LPCDSBUFFERDESC)v26, (LPDIRECTSOUNDBUFFER *)(this + 32), 0) >= 0 )
        {
          sub_41CE60((int)v5, *v5);
          v13 = *v5;
          v14 = v26[2] >> 1;
          *((_DWORD *)this + 83) = v26[2] >> 1;
          (*(void (__stdcall **)(unsigned int, _DWORD, int, __int64 *, int *, _DWORD, _DWORD, _DWORD))(*(_DWORD *)v13 + 44))(
            ...
            0,
            0);
          v15 = 2 * sf_read_short(*((_DWORD *)this + 75), v25, (unsigned int)v24 >> 1);
          if ( v15 < v24 )
          {
            sf_close(*((_DWORD *)this + 75));
            *((_DWORD *)this + 75) = 0;
            ++dword_5200DC;
            if ( *this )
            {
              ...
              *((_DWORD *)this + 7) = 0;
              ...
              {
                ++dword_5200D8;
                sf_read_short(*((_DWORD *)this + 75), v25 + v15, (unsigned int)(v24 - v15) >> 1);
              }
              else
              {
                sub_4229D0(aCanTResetStrea, (_BYTE)this + 40);
              }
            }
            else
            {
