...
char __cdecl sub_4697A0(int self)
{
  ...
  sub_46A280(self, aExtradataDat);
  v10 = 0;
  v2 = (void *)_findfirst(aIni, (struct _finddata_t *)v8);
  if ( v2 != (void *)-1 )
  {
    do
    {
      if ( strcmp(v9, File) )
      {
        sub_46A570(0, (char *)1, (uintptr_t)v8, 0);
        sub_46A3A0((_BYTE *)self, v9);
      }
    }
    while ( _findnext((intptr_t)v2, (struct _finddata_t *)v8) != -1 );
  }
  for ( i = 0; i < (int)*(_DWORD *)(self + 24); ++i )
    sub_469370(*(_DWORD *)(*(_DWORD *)(self + 20) + 4 * i), self);
  qsort(*(void **)(self + 20), *(_DWORD *)(self + 24), 4u, sub_46A230);
  for ( j = 0; j < (int)*(_DWORD *)(self + 24); ++j )
    *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(self + 20) + 4 * j) + 8) = j;
  sub_46A340(self);
  if ( byte_520A10 )
  {
    for ( k = 0; k < (int)*(_DWORD *)(self + 24); ++k )
    {
