//----- (00478B71) --------------------------------------------------------
extern "C" int __cdecl _setjmp3(jmp_buf, int);
void* __cdecl sub_478B71(_BYTE *a1, int a2, int a3, int a4)
{
  int *v4; // eax
  int v6; // eax
