...
int sub_428420()
{
  ...
  int v2; // eax
  int v3; // eax
  _DWORD v5[1]; // [esp+0h] [ebp-460h] BYREF
  ...
  sub_428860(v5, Filename);
  v9 = 0;
  v0 = sub_428F20((int*)v5) - 1;
  if ( v0 )
  {
    v1 = v0 - 1;
    if ( v1 )
  ...
  if ( !sub_428F20((int*)v5) )
  {
    v6 = (_BYTE*)v5;
    sub_429B40((void**)&v6, 1, 1, 16, Buffer, 600);
  }
