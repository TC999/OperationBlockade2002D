...
_BYTE *__cdecl sub_409AD0(int *self, int a2, unsigned int a3);
_BYTE *__cdecl sub_4113F0(_DWORD *self, int a2, short a3, short a4, char a5);
...
_DWORD *__cdecl sub_4221E0(_DWORD *self);
...
_DWORD *__cdecl sub_43BB70(_DWORD *self, int a2);
...
_DWORD *__cdecl sub_43EF90(void *self, _DWORD *a2, int a3);
_DWORD *__cdecl sub_43EFC0(void *self, _DWORD *a2, const CHAR *a3, int a4);
_DWORD *__cdecl sub_43EFF0(_DWORD *self, _DWORD *a2);
_DWORD *__cdecl sub_4431F0(_DWORD *self, int a2, int a3);
...
_DWORD *__cdecl sub_45ECB0(_DWORD *self);
...
_DWORD *__cdecl sub_463B30( _DWORD *self, _DWORD *a2, int a3, int a4, int a5, float a6, float a7, int a8, int a9, char *a10, int a11, int a12);
...
BOOL __cdecl sub_4057E0(FILE **self, void *Buffer);
BOOL __cdecl sub_405800(FILE **self, void *Buffer);
BOOL __cdecl sub_405820(FILE **self, FILE **a2);
bool __cdecl sub_4059A0(FILE **self, unsigned int Buffer);
BOOL __cdecl sub_407A90( int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int *a10, _DWORD *a11, int a12, int a13);
...
BOOL __cdecl sub_47DA03(void* Buf);
...
char *__cdecl sub_47AEDA(void* Buf, int a2, int a3);
char *__cdecl sub_47D991(int a1, int a2, char *a3, char a4, unsigned int a5);
char *__cdecl sub_47E11F(void* Buf);
...
char __cdecl sub_402480(_BYTE *self, char a2);
...
char __cdecl sub_405C00(_DWORD *self, int a2);
...
char __cdecl sub_409BE0( int a1, int a2, int a3, int a4, int a5, float a6, float a7, float a8, float a9, float a10, int a11, float a12, float a13, int a14);
...
char __cdecl sub_411820(int self, short a2, int a3, unsigned int a4);
...
char __cdecl sub_415910(void *self);
...
char __cdecl sub_42CB00(void *self);
char __cdecl sub_42CB20(_DWORD *self, int a2);
...
char __cdecl sub_43CDB0(_DWORD *self, int a2);
char __cdecl sub_43D010(int *self, char *String1, int a3);
...
char __cdecl sub_43D5B0(int self, int a2);
char __cdecl sub_43D5D0(int self, char *String1, int a3);
char __cdecl sub_43D8A0(_DWORD *self, int a2);
...
char __cdecl sub_450A10(_DWORD *self, int a2, int a3);
char __cdecl sub_450A30(int self, int a2);
char __cdecl sub_450BB0(_DWORD *self);
char __cdecl sub_455830(void *self);
...
char __cdecl sub_465CD0(void *self);
...
char __cdecl sub_468F60(int self, int a2);
...
char __cdecl sub_47B8BE(unsigned short *a1, char *a2);
...
char __cdecl sub_48559A(int a1, int a2, short *a3, _DWORD *a4, int a5);
char __cdecl sub_48566F(int a1, int a2, short *a3, int a4, int a5);
...
const char *__cdecl sub_4242F0(_DWORD **self, char *String2);
...
double __cdecl sub_40E5D0(float *self);
...
double __cdecl sub_48861D( char a1, unsigned int a2, short a3, double result, int a5, int a6);
double __cdecl sub_4886ED( char a1, unsigned int a2, short a3, double result, int a5, int a6);
...
float *__cdecl sub_4066C0( _DWORD *a1, int a2, _DWORD *a3, float *a4, float *a5, float *a6, float *a7, float *a8);
...
float *__cdecl sub_421100(float *self, float *a2);
...
float *__cdecl sub_47B1B2(unsigned short *a1, float *a2, float *a3, int a4);
...
int (__cdecl *__cdecl sub_478E09(void* Buf, int a2, int a3))(void*, int, _DWORD);
int (__cdecl *__cdecl sub_4791B0(void* Buf, int *a2))(void*, int, _DWORD);
...
int __cdecl sub_402690(_DWORD *self, int a2, int a3, int a4);
...
int __cdecl sub_407390(_DWORD *self, int a2, char a3);
...
int __cdecl sub_408890(_DWORD **self);
...
int __cdecl sub_40A800(int self);
...
int __cdecl sub_413240(_DWORD *self, int a2, int a3, int a4, int a5);
...
int __cdecl sub_414CE0(void *self);
...
int __cdecl sub_41C050(_DWORD *self);
int __cdecl sub_41C060(_DWORD *self, int a2, int a3, int a4);
int __cdecl sub_41C090(_DWORD *self, int a2, int a3);
...
int __cdecl sub_41D8B0(_DWORD *self, int a2, int a3, int a4, int a5, int a6, int a7);
...
int __cdecl sub_41FBB0( int a1, int a2, int a3, float a4, float a5, int a6, float a7, float a8, float a9, float a10, float a11, float a12, float a13, float a14);
...
int __cdecl sub_421B20(_DWORD *self, int a2);
...
int __cdecl sub_428580(void *self);
...
int __cdecl sub_428EC0(void *self, int a2);
int __cdecl sub_428EE0(void *self, int a2);
int __cdecl sub_428F00(void *self);
...
int __cdecl sub_42A5C0(void *self);
int __cdecl sub_42A770(void *self);
int __cdecl sub_42A780(_DWORD *self);
int __cdecl sub_42A7A0(_DWORD *self);
int __cdecl sub_42A7C0(int self);
int __cdecl sub_42A840(_DWORD *self);
int __cdecl sub_42A860(LPVOID *self);
int __cdecl sub_42AA30(int a1, int a2, char *k);
...
int __cdecl sub_43F330(_DWORD *self);
...
int __cdecl sub_44C610(void *self);
int __cdecl sub_44C710(void *self);
int __cdecl sub_44C990(LPVOID *self);
...
int __cdecl sub_44E910(_DWORD *self);
...
int __cdecl sub_45A870(_DWORD *self, int a2);
...
int __cdecl sub_45EC70(_DWORD *self);
...
int __cdecl sub_464AA0(_DWORD *self);
int __cdecl sub_464AC0(_DWORD *self);
...
int __cdecl sub_46CB5B( int a1, char a2, unsigned int *a3, unsigned int *a4, unsigned int *a5, unsigned int *a6, int a7, unsigned int *a8, unsigned int a9, int a10);
...
int __cdecl sub_46D461( char a1, int a2, int a3, int a4, int a5, int a6, unsigned int a7, int a8, unsigned int a9, BOOL a10, int a11, int a12, int a13, int a14, void *a15, int *a16);
int __cdecl sub_46D89A( char a1, int a2, int a3, int a4, int a5, unsigned int a6, int a7, unsigned int a8, BOOL a9, int a10, int a11, int a12, int a13, void *a14, int *a15);
...
int __cdecl sub_47AE26(void* Buf, int a2, int a3);
int __cdecl sub_47AE90(int a1, unsigned int a2, unsigned int a3);
int __cdecl sub_47AF2E(int a1, LPVOID lpMem);
...
int __cdecl sub_47B9F1(unsigned short *a1, char *a2);
...
int __cdecl sub_47D9E9(int Buf, int a2, int a3);
int __cdecl sub_47E2BE(void* Buf, unsigned int a2);
int __cdecl sub_47E66C(void* Buf, int a2, unsigned int a3);
int __cdecl sub_47EA58(void* Buf, int a2, unsigned int a3);
int __cdecl sub_47EAA3(int a1, void* Buf);
...
int __cdecl sub_485FFB( unsigned int *a1, _DWORD *a2, unsigned int a3, unsigned int a4, int a5, int a6, _DWORD *a7, int a8, unsigned int *a9, unsigned int *a10);
...
int __cdecl sub_486659(short *a1, short *a2, int *a3, int a4, int a5, int a6);
...
LPVOID *__cdecl sub_476BAA(LPVOID *self, char a2);
...
LRESULT sub_41A390();
short *__cdecl sub_47328E(_DWORD *self, int a2, int a3, float *a4);
short __cdecl sub_443180(_DWORD *self, int a2);
short __cdecl sub_47B3C0(_BYTE *a1, int a2, unsigned short a3);
short __cdecl sub_47B421(_BYTE *a1, int a2, int a3, int a4);
short __cdecl sub_47BAF1(_BYTE *a1, int a2);
short __cdecl sub_47BB23(_BYTE *a1, _WORD *a2);
short __cdecl sub_47BB7C(_BYTE *a1, int a2);
short __cdecl sub_483762(_DWORD *a1, int a2, _DWORD *a3, int a4);
short __cdecl sub_4871C8(_WORD *a1, _WORD *a2, _WORD *a3, int a4, int a5, int a6);
...
unsigned __int8 __cdecl sub_47DA61(void* Buf, unsigned __int8 *a2);
...
unsigned int __cdecl sub_4720BE(void* Buf, void *a2, unsigned int a3);
unsigned int __cdecl sub_479754(int a1, int a2);
unsigned int __cdecl sub_479B06(int a1, int a2, unsigned int a3, char a4);
unsigned int __cdecl sub_47B0C6(unsigned short *a1, unsigned int *a2);
...
void *__cdecl sub_47D91C(void* Buf, size_t Size);
...
void __cdecl sub_40B1B0(const char *self, char *ArgList, float *a3);
void __cdecl sub_40B1D0(const char *self, char *ArgList, float *a3, float *a4);
...
void __cdecl sub_40E620(LPVOID *self);
...
void __cdecl sub_413270(float *self, int a2);
...
void __cdecl sub_41C0E0(float *self);
...
void __cdecl sub_42A9D0(LPVOID *self);
...
void __cdecl sub_450AA0(int **self, int a2, int a3);
...
void __cdecl sub_472101(void* Buf, const char *ArgList);
...
void __cdecl sub_4788E1(int a1);
void __cdecl sub_478AEB(void* Buf, int a2);
void __cdecl sub_478B21(void* Buf, const void *a2);
void __cdecl sub_479839(int *a1, int a2);
void __cdecl sub_47A6F4(void* Buf);
void __cdecl sub_47A9FD(void* Buf);
void __cdecl sub_47AB10(void* Buf);
...
void __cdecl sub_47AD6C(int a1, int a2, int a3, short a4);
...
void __cdecl sub_47E34C(void* Buf, int a2, int a3);
void __cdecl sub_47E542(void* Buf, int a2, int a3);
void __cdecl sub_47E6B6(void* Buf, int a2, unsigned int a3);
void __cdecl sub_47E7C1(void* Buf, int a2, unsigned int a3);
void __cdecl sub_47E8B0(void* Buf, int a2, size_t Size);
