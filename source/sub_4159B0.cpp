//----- (004159B0) --------------------------------------------------------
void __thiscall sub_4159B0(int self, float a2, _DWORD *a3, _DWORD *a4, float *a5, float *a6, float *a7)
{
  double v8; // st7
  double v9; // st7
  int v10; // ecx
  ...
  if ( v8 == 0.0 )
    ...
    v9 = a2 / v8;
  v10 = 0;
  v11 = v9 * *(float *)(self + 20) + *(float *)(self + 16);
  *(float *)(self + 16) = v11;
  if ( v11 <= 1.0 )
    goto LABEL_9;
  v12 = *(float *)(self + 16);
...
LABEL_9:
  ...
  *a7 = v119;
  ...
  else
  {
    ...
    v26[2] = v27;
    *(_DWORD *)(self + 36) = *v25;
    *(_DWORD *)(self + 40) = v25[1];
    v28 = v157;
    *(_DWORD *)(self + 44) = v25[2];
    v124 = v28;
    v125 = v158;
    v126 = 0.0;
