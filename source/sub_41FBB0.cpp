        ...
        float a14)
{
  ...
  v130 = a4 * 0.5;
  sub_406BE0((_DWORD*)v129);
  v14 = (float *)sub_408F30((_DWORD*)dword_520970);
  v71 = v14[13] - v14[10];
  v46 = v14[12] - v14[9];
  v21 = v14[11] - v14[8];
  sub_40F4A0(NULL, LODWORD(v21), LODWORD(v46), LODWORD(v71));
  sub_46BFED((int)v129, (int)v128, a5);
  sub_40E880((void*)v129, a1, a2, a3);
  v15 = -a13;
  v72 = v15 * *(float *)&dword_520120;
  v47 = v15 * *(float *)&dword_52011C;
  v22 = v15 * *(float *)&dword_520118;
  sub_40F4A0(NULL, LODWORD(v22), LODWORD(v47), LODWORD(v72));
  v16 = -a14;
  v73 = v16 * *(float *)&dword_520110;
  v48 = v16 * *(float *)&dword_52010C;
  v23 = v16 * *(float *)&dword_520108;
  sub_40F4A0(NULL, LODWORD(v23), LODWORD(v48), LODWORD(v73));
  v74 = v102 + v105;
  v49 = v101 + v104;
  v24 = *(float *)&v100 + v103;
  sub_40F4A0(NULL, LODWORD(v24), LODWORD(v49), LODWORD(v74));
  v17 = v130 + v130;
  v75 = v99 * v17;
  v50 = v98 * v17;
  v25 = v97 * v17;
  sub_40F4A0(NULL, LODWORD(v25), LODWORD(v50), LODWORD(v75));
  v76 = *(float *)&dword_520120 * a11;
  v51 = *(float *)&dword_52011C * a11;
  v26 = *(float *)&dword_520118 * a11;
  sub_40F4A0(NULL, LODWORD(v26), LODWORD(v51), LODWORD(v76));
  v77 = *(float *)&dword_520110 * a12;
  v52 = *(float *)&dword_52010C * a12;
  v27 = *(float *)&dword_520108 * a12;
  sub_40F4A0(NULL, LODWORD(v27), LODWORD(v52), LODWORD(v77));
  v78 = v99 + v105;
  v53 = v98 + v104;
  v28 = v97 + v103;
  sub_40F4A0(NULL, LODWORD(v28), LODWORD(v53), LODWORD(v78));
  v79 = v102 * v130;
  v54 = v101 * v130;
  v29 = *(float *)&v100 * v130;
  sub_40F4A0(NULL, LODWORD(v29), LODWORD(v54), LODWORD(v79));
  v80 = v114 + v108;
  v55 = v113 + v107;
  v30 = v112 + v106;
  sub_40F4A0(NULL, LODWORD(v30), LODWORD(v55), LODWORD(v80));
  sub_408A30(NULL, (_DWORD*)&v109);
  v81 = *(float *)&dword_520120 * a11;
  v56 = *(float *)&dword_52011C * a11;
  v31 = *(float *)&dword_520118 * a11;
  sub_40F4A0(NULL, LODWORD(v31), LODWORD(v56), LODWORD(v81));
  v82 = *(float *)&dword_520110 * a12;
  v57 = *(float *)&dword_52010C * a12;
  v32 = *(float *)&dword_520108 * a12;
  sub_40F4A0(NULL, LODWORD(v32), LODWORD(v57), LODWORD(v82));
  v83 = v108 - v99;
  v58 = v107 - v98;
  v33 = v106 - v97;
  sub_40F4A0(NULL, LODWORD(v33), LODWORD(v58), LODWORD(v83));
  v84 = v105 * v130;
  v59 = v104 * v130;
  v34 = v103 * v130;
  sub_40F4A0(NULL, LODWORD(v34), LODWORD(v59), LODWORD(v84));
  v85 = v102 + v114;
  v60 = v101 + v113;
  v35 = *(float *)&v100 + v112;
  sub_40F4A0(NULL, LODWORD(v35), LODWORD(v60), LODWORD(v85));
  sub_408A30(NULL, (_DWORD*)&v109);
  v86 = *(float *)&dword_520120 * a11;
  v61 = *(float *)&dword_52011C * a11;
  v36 = *(float *)&dword_520118 * a11;
  sub_40F4A0(NULL, LODWORD(v36), LODWORD(v61), LODWORD(v86));
  v87 = -*(float *)&dword_520110;
  v62 = -*(float *)&dword_52010C;
  v37 = -*(float *)&dword_520108;
  sub_40F4A0(NULL, LODWORD(v37), LODWORD(v62), LODWORD(v87));
  v88 = v108 * a12;
  v63 = v107 * a12;
  v38 = v106 * a12;
  sub_40F4A0(NULL, LODWORD(v38), LODWORD(v63), LODWORD(v88));
  v89 = v99 + v105;
  v64 = v98 + v104;
  v39 = v97 + v103;
  sub_40F4A0(NULL, LODWORD(v39), LODWORD(v64), LODWORD(v89));
  v90 = v102 * v130;
  v65 = v101 * v130;
  v40 = *(float *)&v100 * v130;
  sub_40F4A0(NULL, LODWORD(v40), LODWORD(v65), LODWORD(v90));
  v91 = v111 + v114;
  v66 = v110 + v113;
  v41 = v109 + v112;
  sub_40F4A0(NULL, LODWORD(v41), LODWORD(v66), LODWORD(v91));
  sub_408A30(NULL, (_DWORD*)v127);
  v92 = *(float *)&dword_520120 * a11;
  v67 = *(float *)&dword_52011C * a11;
  v42 = *(float *)&dword_520118 * a11;
  sub_40F4A0(NULL, LODWORD(v42), LODWORD(v67), LODWORD(v92));
  v93 = -*(float *)&dword_520110;
  v68 = -*(float *)&dword_52010C;
  v43 = -*(float *)&dword_520108;
  sub_40F4A0(NULL, LODWORD(v43), LODWORD(v68), LODWORD(v93));
  v94 = v111 * a12;
  v69 = v110 * a12;
  v44 = v109 * a12;
  sub_40F4A0(NULL, LODWORD(v44), LODWORD(v69), LODWORD(v94));
  v95 = v108 - v99;
  v70 = v107 - v98;
  v45 = v106 - v97;
  sub_40F4A0(NULL, LODWORD(v45), LODWORD(v70), LODWORD(v95));
  v18 = sub_4162F0((float*)v127, (float *)&v100, v130);
  v19 = (float *)sub_4162C0(v18, &v103, &v112);
  sub_408A30(NULL, (_DWORD*)v19);
  sub_421100(NULL, (float*)v129);
  sub_421100(NULL, (float*)v129);
  sub_421100(NULL, (float*)v129);
  sub_421100(NULL, (float*)v129);
  (*(void (__stdcall **)(int, _DWORD, int, int *, _DWORD))(*(_DWORD *)(_DWORD*)dword_5200F8 + 44))(
    dword_5200F8,
    0,
    24576,
    &v96,
  ...
  *(float *)(v96 + 88) = a9;
  *(float *)(v96 + 92) = a10;
  (*(void (__stdcall **)(int))(*(_DWORD *)(_DWORD*)dword_5200F8 + 48))(dword_5200F8);
  result = 0;
  if ( ++dword_520100 == 256 )
  {
    result = sub_4204C0();
