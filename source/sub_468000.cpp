//----- (00468000) --------------------------------------------------------
int __thiscall sub_468000(int this)
{
  int v2; // edi
  int v3; // eax
  int v4; // ebx
  ...
  *(_DWORD *)this = &off_499CD4;
  sub_403D90((char *)this, aIslandPf3);
  sub_403E30(this);
  *(_DWORD *)(this + 588) = sub_422400(*(_DWORD **)(dword_520970 + 124), aWater1Tga, 0);
  *(_DWORD *)(this + 592) = sub_422400(*(_DWORD **)(dword_520970 + 124), aWater2Tga, 0);
  *(_DWORD *)(this + 596) = sub_422400(*(_DWORD **)(dword_520970 + 124), aWater3Tga, 0);
  *(_DWORD *)(this + 600) = sub_422400(*(_DWORD **)(dword_520970 + 124), aWater4Tga, 0);
  v3 = *(_DWORD *)(this + 8);
  *(_DWORD *)(this + 604) = 0;
  *(_DWORD *)(this + 608) = 1;
...
LABEL_15:
    ...
    *(_DWORD *)(this + 616) = v10;
    memset((void *)(v10 + 4 * *(_DWORD *)(this + 620)), 0, 4 * (*(_DWORD *)(this + 624) - *(_DWORD *)(this + 620)));
LABEL_13:
    *(_DWORD *)(*(_DWORD *)(this + 616) + 4 * *(_DWORD *)(this + 620) - 4) = v5;
    if ( v5 )
    {
